module PipelineCPU_trojan_ctrl (
    input clk,
    input start,
    output [31:0] dummy_pc,         
    output [31:0] dummy_alu_out,    
    output [31:0] dummy_mem_data,  
    output [31:0] dummy_wb_data
    ...
    assign dummy_pc       = pc_o;
    assign dummy_alu_out  = ALUOut;
    assign dummy_mem_data = memReadData_memwb_out;
    assign dummy_wb_data  = wb_memwb_out;
    ...
    hazard_detection_unit_ctrl m_hazard_unit (
